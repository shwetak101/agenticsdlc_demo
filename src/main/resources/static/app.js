(() => {
  ...
  function approvalPanel() {
    ...
    const queueRows = queue.length ? queue.map(refund => {
      const independent = refund.requesterUsername !== state.session.user.username;
